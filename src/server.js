...
const { Router, Publisher } = require('zeromq')
...
const argv = yargs
  ...
  .example(
    '$0 eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ'
  )
  .demand(1)
  .number('port')
  .default('port', 9900)
  ...
  .describe(
    'batchSize',
    'The number of attempts assigned to every client in a batch'
  )
  .number('start')
  .alias('s', 'start')
